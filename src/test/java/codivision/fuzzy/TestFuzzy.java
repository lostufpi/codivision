...
public class TestFuzzy {
	...
	public static void main(String[] args) {
		...
		r1.setAuthor(new Author("irva", "irva@email"));
		r2.setAuthor(new Author("toin", "toin@email"));
		r3.setAuthor(new Author("nilton", "nilton@email"));
		...
		r0.setAuthor(new Author("toin", "toin@email"));
